                                ...
                                <div class="product-item bg-light mb-4">
                                    <div class="product-img position-relative overflow-hidden">
                                        ...
                                        <div class="product-action">
                                            ...
                                            <a class="btn btn-outline-dark btn-square" onclick="addProductToLoved({{ $product['id'] }})"><i
                                                    class="@if (in_array($product->id,Session::get('like', [])))
                                                        fas
                                                        @else
                                                        far
                                                    @endif fa-heart" id="{{ $product['id'] }}"></i></a>
                                            <a class="btn btn-outline-dark btn-square" href="{{ route('shop.item', $product->id) }}"><i
