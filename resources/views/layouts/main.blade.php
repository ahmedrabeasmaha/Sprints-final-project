...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/font-awesome@3.2.1/css/font-awesome.css">
                ...
                <div class="d-inline-flex align-items-center">
                    ...
                    @auth
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="{{ route('dashboard') }}"><button class="dropdown-item" type="button">Dashboard</button></a>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            <a href="{{ url('') }}" class="{{request()->routeIs('home') ? 'active' : ''}} nav-item nav-link">Home</a>
                            <a href="{{ url('shop') }}" class="{{request()->routeIs('shop*') ? 'active' : ''}} nav-item nav-link">Shop</a>
                            <a href="{{ url('cart') }}" class="nav-item nav-link">Cart</a>
                            <a href="{{ url('checkout') }}" class="nav-item nav-link">Checkout</a>
                            <a href="{{ url('contact') }}" class="{{request()->routeIs('contact*') ? 'active' : ''}} nav-item nav-link">Contact</a>
                        </div>
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <a href="" class="btn px-0">
                                <i class="fas fa-heart text-primary"></i>
                                <span class="badge text-secondary border border-secondary rounded-circle"
                                    style="padding-bottom: 2px" id="like_count">{{ count(session()->get('like', [])) }}</span>
                            </a>
                            <a href="" class="btn px-0 ml-3">
                                <i class="fas fa-shopping-cart text-primary"></i>
                                <span class="badge text-secondary border border-secondary rounded-circle"
                                    style="padding-bottom: 2px"
                                    id="product_count">{{ array_sum(session()->get('ids', [])) }}</span>
                            </a>
                        </div>
                    </div>
                </nav>
